			...
			<div className="min-h-screen bg-[#f7f1e6] px-5 py-8 lg:px-20 lg:py-10">
				<div className="mx-auto flex w-full max-w-7xl flex-col gap-8">
					<main className="mb-10 flex flex-1 flex-col gap-6">
						<header className="border border-[#061a3d]/12 bg-[radial-gradient(circle_at_top_left,rgba(214,173,88,.16),transparent_40%),white] p-8 shadow-[0_20px_60px_rgba(6,26,61,.08)]">
						...
						<section className="space-y-6 border border-[#061a3d]/12 bg-white p-8 shadow-[0_20px_60px_rgba(6,26,61,.08)]">
								...
								<div className="flex flex-col gap-2 w-full">
									...
									<div className="relative">
										<select
											...
											className="w-full appearance-none border border-[#061a3d]/15 bg-[#fdfaf4] px-4 py-3 pr-12 text-[#182033] focus:border-[#d6ad58] focus:outline-none focus:ring-2 focus:ring-[#d6ad58]/20 cursor-pointer"
										>
